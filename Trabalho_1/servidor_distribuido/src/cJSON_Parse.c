...
cJSON* buildJson(StateSensor estados, unsigned short porta_servidor_distribuido) {
    ...
    janela = cJSON_CreateNumber(estados.janela);
    ...
    projetor = cJSON_CreateNumber(estados.projetor);
    ...
    cJSON_AddItemToObject(estados_json, "janela", janela);
    ...
    cJSON_AddItemToObject(estados_json, "projetor", projetor);
